export const projects = [
  {
    ...
    description: "Cryptocurrency Tracker is a fully responsive web application that fetches and displays prices and stats of various Cryptocurrencies.",
    image: '/images/crypto.JPG',
    tags: ['JavaScript', 'ChartJS', 'Firebase', 'CoinGecko API'],
    source: 'https://github.com/saicharith2012/cryptocurrency-tracker',
  ...
  },
  {
    ...
    description: "Serverless OTP-System is an OTP service based responsive web application. Can process more than 30,000 OTP requests in a second",
    image: '/images/otp.JPG',
    tags: ['ReactJS', 'AWS Lambda', 'AWS API Gateway'],
    source: 'https://github.com/saicharith2012/Serverless-OTP-system-frontend',
    id: 2,
  },
  {
    title: 'Shopping Mall Database',
    description: "Shopping Mall Database Management system is developed using C++ Programming Language and includes STL's such as Vectors.",
    image: '/images/shopping.jpg',
    tags: ['C++', 'Bash'],
    source: 'https://github.com/shahlaukik/shopping-mall-database-with-oopl',
    id: 3,
  },
  // {
  //   title: 'Lenovo SNAPit',
